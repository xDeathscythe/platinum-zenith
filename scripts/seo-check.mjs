...
const checks = [
  ...
  { name: 'Sitemap freshness for key landing pages', script: 'scripts/seo-sitemap-freshness-audit.mjs' },
  ...
  { name: 'WebSite SearchAction target + canonicalization', script: 'scripts/seo-website-searchaction-audit.mjs' },

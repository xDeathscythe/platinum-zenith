...
export default function AnalyticsConsent() {
  ...
  return <section aria-label="Podešavanja privatnosti" className="fixed bottom-4 left-4 right-4 sm:right-auto sm:max-w-lg z-[10000] bg-page text-ink border border-edge-2 rounded-2xl p-5 shadow-xl">
    ...
    <p className="text-sm text-ink-2">Uz vaš pristanak merimo posete i interakcije kako bismo poboljšali sajt. Koristimo sopstvenu analitiku, Google Analytics i Microsoft Clarity. Polja sa ličnim podacima ne snimamo. <Link className="underline" to="/politika-privatnosti">Politika privatnosti</Link></p>

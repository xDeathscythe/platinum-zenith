...
const brands = {
  ...
  grubin: {
    ...
    ads: [
      ...
      { text: 'Anatomska obuća za celu porodicu. Poručite sa besplatnom dostavom', img: `${B}grubin-01.webp`, views: '44K', viewsChange: '+96%', revenue: '€8.2K', revenueChange: '+340%', color: 'from-green-400 to-teal-500' },
      { text: 'Kožne sandale za leto. Premium kvalitet po pristupačnoj ceni', img: `${B}grubin-06.webp`, views: '24K', viewsChange: '+55%', revenue: '€3.9K', revenueChange: '+170%', color: 'from-teal-400 to-green-500' },
      { text: 'Grubin Showroom. Online prodavnica anatomske obuće #1 u Srbiji', img: `${B}grubin-03.webp`, views: '21K', viewsChange: '+48%', revenue: '€3.5K', revenueChange: '+150%', color: 'from-emerald-600 to-teal-600' },
      { text: 'Besplatna dostava i zamena. Poručite bez rizika', img: `${B}grubin-07.webp`, views: '31K', viewsChange: '+72%', revenue: '€5.1K', revenueChange: '+230%', color: 'from-green-500 to-cyan-500' },
    ],
  },
}

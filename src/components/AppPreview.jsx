...
const brands = {
  truffles: {
    ...
    ads: [
      { text: 'Premium crni tartufi iz Srbije. Direktna isporuka za restorane', img: `${B}truffles-01.webp`, views: '18K', viewsChange: '+55%', revenue: '€12K', revenueChange: '+180%', color: 'from-amber-600 to-yellow-700' },
      { text: 'Svež tartuf za vaš restoran. Naručite danas, sutra na stolu', img: `${B}truffles-02.webp`, views: '24K', viewsChange: '+68%', revenue: '€18K', revenueChange: '+220%', color: 'from-yellow-500 to-amber-600' },
      { text: 'Tartuf pasta sa svežim crnim tartufom. Restoransko iskustvo kod kuće', img: `${B}truffles-03.webp`, views: '31K', viewsChange: '+82%', revenue: '€22K', revenueChange: '+295%', color: 'from-amber-500 to-orange-600' },
      { text: 'Sveži crni tartufi. Premium kvalitet, ručno brani', img: `${B}truffles-04.webp`, views: '15K', viewsChange: '+41%', revenue: '€9K', revenueChange: '+145%', color: 'from-yellow-600 to-amber-700' },
      { text: 'Crni tartuf na jelu sa mikro zelenisom. Za prave gurmane', img: `${B}truffles-05.webp`, views: '27K', viewsChange: '+72%', revenue: '€15K', revenueChange: '+210%', color: 'from-orange-500 to-amber-600' },
      { text: 'Chef rendanje tartufa direktno na tanjir. Svežina koja se vidi', img: `${B}truffles-06.webp`, views: '21K', viewsChange: '+59%', revenue: '€11K', revenueChange: '+175%', color: 'from-amber-400 to-yellow-500' },
      { text: 'Tegla punih svežih crnih tartufa. Sav kvalitet na dlanu', img: `${B}truffles-07.webp`, views: '33K', viewsChange: '+85%', revenue: '€24K', revenueChange: '+310%', color: 'from-yellow-400 to-amber-500' },
      { text: 'Beli tartuf na tartaru. Delikates za najzahtevnije nepce', img: `${B}truffles-08.webp`, views: '19K', viewsChange: '+48%', revenue: '€10K', revenueChange: '+155%', color: 'from-amber-700 to-yellow-600' },
      { text: 'Beli tartuf izbliza. Kralj među tartufima, direktno iz Srbije', img: `${B}truffles-09.webp`, views: '29K', viewsChange: '+76%', revenue: '€20K', revenueChange: '+260%', color: 'from-orange-400 to-amber-500' },
      { text: 'Sveže sečeni crni tartuf. Tekstura i aroma koji govore sami za sebe', img: `${B}truffles-10.webp`, views: '36K', viewsChange: '+91%', revenue: '€28K', revenueChange: '+340%', color: 'from-yellow-300 to-amber-400' },
      { text: 'Platinum Truffles paket. Svezi crni tartufi spremni za isporuku', img: `${B}truffles-01.webp`, views: '22K', viewsChange: '+62%', revenue: '€14K', revenueChange: '+195%', color: 'from-amber-500 to-yellow-600' },
      { text: 'Od šume do kuhinje za 24h. Isporuka za Srbiju i EU', img: `${B}truffles-02.webp`, views: '14K', viewsChange: '+37%', revenue: '€7K', revenueChange: '+120%', color: 'from-yellow-500 to-orange-400' },
      { text: 'Tartuf rendanje na vrhu jela. Čist ukus, bez kompromisa', img: `${B}truffles-06.webp`, views: '25K', viewsChange: '+65%', revenue: '€16K', revenueChange: '+230%', color: 'from-amber-600 to-orange-500' },
      { text: 'Tegla tartufa za restoran. B2B saradnja sa redovnom isporukom', img: `${B}truffles-07.webp`, views: '17K', viewsChange: '+44%', revenue: '€8K', revenueChange: '+140%', color: 'from-yellow-600 to-amber-500' },
    ],
  },
  medifizio: {
    name: 'Medifizio',
  ...
  grubin: {
    ...
    ads: [
      { text: 'Mekane papuče za hladne dane. Udobnost u svakom koraku', img: `${B}grubin-01.webp`, views: '28K', viewsChange: '+65%', revenue: '€4.2K', revenueChange: '+180%', color: 'from-emerald-500 to-teal-600' },
      { text: 'Muške kožne sandale. Elegancija i kvalitet za svaki dan', img: `${B}grubin-02.webp`, views: '35K', viewsChange: '+78%', revenue: '€5.8K', revenueChange: '+220%', color: 'from-teal-400 to-emerald-500' },
      { text: 'Bele anatomske klompe sa zlatnom kopčom. Udobnost na poslu', img: `${B}grubin-03.webp`, views: '22K', viewsChange: '+52%', revenue: '€3.6K', revenueChange: '+155%', color: 'from-emerald-600 to-green-700' },
      { text: 'Letnje sandale sa šljokicama. Za male princeze i njihove mame', img: `${B}grubin-04.webp`, views: '41K', viewsChange: '+92%', revenue: '€7.1K', revenueChange: '+310%', color: 'from-green-400 to-emerald-500' },
      { text: 'Metalik sandale sa platformom. Zakoračite u stil', img: `${B}grubin-05.webp`, views: '19K', viewsChange: '+45%', revenue: '€3.1K', revenueChange: '+140%', color: 'from-teal-500 to-cyan-600' },
      { text: 'Zelene kožne sandale. Boja sezone na vašim stopalima', img: `${B}grubin-06.webp`, views: '26K', viewsChange: '+59%', revenue: '€4.5K', revenueChange: '+195%', color: 'from-emerald-400 to-teal-500' },
      { text: 'Letnji par za plažu i grad. Šljokice i koža u jednom', img: `${B}grubin-07.webp`, views: '33K', viewsChange: '+75%', revenue: '€5.4K', revenueChange: '+245%', color: 'from-cyan-400 to-teal-500' },
      { text: 'Zimske papuče pored kamina. Toplo, mekano, Grubin', img: `${B}grubin-08.webp`, views: '38K', viewsChange: '+85%', revenue: '€6.3K', revenueChange: '+270%', color: 'from-green-500 to-emerald-600' },
      { text: 'Sive teddy papuče sa kopčom. Kućni komfor na drugom nivou', img: `${B}grubin-09.webp`, views: '16K', viewsChange: '+39%', revenue: '€2.8K', revenueChange: '+125%', color: 'from-teal-600 to-emerald-700' },
      { text: 'Letnje papuče za bazen. Tirkizna i crvena. Odaberite svoju', img: `${B}grubin-10.webp`, views: '29K', viewsChange: '+68%', revenue: '€4.9K', revenueChange: '+210%', color: 'from-emerald-500 to-green-600' },
      { text: 'Teddy papuče sa zlatnom kopčom. Zelena i siva, birajte vašu', img: `${B}grubin-11.webp`, views: '44K', viewsChange: '+96%', revenue: '€8.2K', revenueChange: '+340%', color: 'from-green-400 to-teal-500' },
      { text: 'Kožne sandale sa zlatnim kopčama. Elegancija za leto', img: `${B}grubin-12.webp`, views: '24K', viewsChange: '+55%', revenue: '€3.9K', revenueChange: '+170%', color: 'from-teal-400 to-green-500' },
      { text: 'Crne kožne klompe. Profesionalni izgled, anatomska udobnost', img: `${B}grubin-13.webp`, views: '21K', viewsChange: '+48%', revenue: '€3.5K', revenueChange: '+150%', color: 'from-emerald-600 to-teal-600' },
      { text: 'Tri boje, jedan kvalitet. Anatomske sandale za svačiji stil', img: `${B}grubin-14.webp`, views: '31K', viewsChange: '+72%', revenue: '€5.1K', revenueChange: '+230%', color: 'from-green-500 to-cyan-500' },
      { text: 'Perforirane klompe za vruće dane. Bela i roze varijanta', img: `${B}grubin-15.webp`, views: '27K', viewsChange: '+63%', revenue: '€4.6K', revenueChange: '+200%', color: 'from-emerald-400 to-cyan-500' },
      { text: 'Crne Grubin sandale sa srebrnastom kopčom. Klasika koja ne prolazi', img: `${B}grubin-16.webp`, views: '36K', viewsChange: '+81%', revenue: '€6.1K', revenueChange: '+265%', color: 'from-teal-500 to-emerald-600' },
      { text: 'Cow print papuče. Za one koji vole da se istaknu', img: `${B}grubin-17.webp`, views: '22K', viewsChange: '+50%', revenue: '€3.7K', revenueChange: '+160%', color: 'from-green-400 to-emerald-500' },
      { text: 'Leopard teddy papuče. Mekane, tople, stilske', img: `${B}grubin-18.webp`, views: '30K', viewsChange: '+70%', revenue: '€5.0K', revenueChange: '+225%', color: 'from-amber-500 to-emerald-500' },
    ],
  },
}

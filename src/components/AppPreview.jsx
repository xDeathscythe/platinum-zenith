...
const brands = {
  truffles: {
    ...
    ads: [
      ...
      { text: '⚫ Jedan tartuf. Jedna šuma. Nula aditiva', img: `${B}truffles-11.webp?v=343`, views: '22K', viewsChange: '+62%', revenue: '€14K', revenueChange: '+195%', color: 'from-amber-500 to-yellow-600' },
      ...
      { text: '📦 Od šume do vaše kuhinje za 24h. Srbija i EU', img: `${B}truffles-13.webp?v=343`, views: '25K', viewsChange: '+65%', revenue: '€16K', revenueChange: '+230%', color: 'from-amber-600 to-orange-500' },

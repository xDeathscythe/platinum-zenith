...
const brands = {
  ...
  grubin: {
    ...
    ads: [
      ...
      { text: '👞 Muške kožne papuče. Elegancija i kvalitet za svaki dan', img: `${B}grubin-02.webp`, views: '35K', viewsChange: '+78%', revenue: '€5.8K', revenueChange: '+220%', color: 'from-teal-400 to-emerald-500' },
      ...
      { text: '🪩 Metalik papuče sa platformom. Zakoračite u stil!', img: `${B}grubin-05.webp`, views: '19K', viewsChange: '+45%', revenue: '€3.1K', revenueChange: '+140%', color: 'from-teal-500 to-cyan-600' },
      { text: '🌿 Zelene kožne papuče. Boja sezone na vašim stopalima', img: `${B}grubin-06.webp`, views: '26K', viewsChange: '+59%', revenue: '€4.5K', revenueChange: '+195%', color: 'from-emerald-400 to-teal-500' },
      { text: '☀️ Za plažu i grad. Šljokice i koža u jednom paru!', img: `${B}grubin-07.webp`, views: '33K', viewsChange: '+75%', revenue: '€5.4K', revenueChange: '+245%', color: 'from-cyan-400 to-teal-500' },
      ...
      { text: '🏖️ Letnje papuče za bazen! Tirkizna i crvena. Birajte svoju 🩴', img: `${B}grubin-10.webp`, views: '29K', viewsChange: '+68%', revenue: '€4.9K', revenueChange: '+210%', color: 'from-emerald-500 to-green-600' },
      { text: '💚 Teddy papuče sa zlatnom kopčom. Zelena i siva — birajte!', img: `${B}grubin-11.webp`, views: '44K', viewsChange: '+96%', revenue: '€8.2K', revenueChange: '+340%', color: 'from-green-400 to-teal-500' },
      { text: '👡 Kožne papuče sa zlatnim kopčama. Elegancija za leto!', img: `${B}grubin-12.webp`, views: '24K', viewsChange: '+55%', revenue: '€3.9K', revenueChange: '+170%', color: 'from-teal-400 to-green-500' },
      ...
      { text: '🎨 Tri boje, jedan kvalitet. Anatomske papuče za svačiji stil!', img: `${B}grubin-14.webp`, views: '31K', viewsChange: '+72%', revenue: '€5.1K', revenueChange: '+230%', color: 'from-green-500 to-cyan-500' },
      ...
      { text: '🏃‍♀️ Crne Grubin papuče sa srebrnastom kopčom. Klasika!', img: `${B}grubin-16.webp`, views: '36K', viewsChange: '+81%', revenue: '€6.1K', revenueChange: '+265%', color: 'from-teal-500 to-emerald-600' },

...
export const pageMeta = {
  ...
  '/web-design': {
    ...
    description: 'Profesionalna izrada sajtova koji pretvaraju posetioce u klijente. PageSpeed 95+, mobile-first dizajn, SEO od prvog dana. Isporuka za 2-8 nedelja. Besplatna procena.',
  ...
  '/agencija-vs-freelancer': { title: 'Agencija ili Freelancer? Uporedni Vodič za 2026 | Platinum Zenith', description: 'Agencija vs freelancer: realno poređenje po ceni, kvalitetu, rokovima i pouzdanosti. Konkretni saveti za firme u Srbiji koje biraju izvođača za sajt ili marketing.', keywords: 'agencija vs freelancer, agencija ili freelancer, izrada sajta agencija, freelancer sajt, marketing agencija srbija, freelancer vs agencija cena' },
  ...
  '/marketing-za-restorane': { title: 'Marketing za Restorane | Digitalni Marketing za Ugostiteljstvo | Platinum Zenith', description: 'Specijalizovani marketing za restorane u Srbiji. Google Business optimizacija, društvene mreže, plaćeni oglasi i izrada sajta. Punimo stolice u danima kad je prazno.', keywords: 'marketing za restorane, digitalni marketing ugostiteljstvo, restoran marketing srbija, google business restoran, instagram za restorane, sajt za restoran' },

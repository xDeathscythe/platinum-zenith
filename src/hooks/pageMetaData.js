...
export const pageMeta = {
  ...
  '/marketing-agencija-uzice': { title: 'Marketing Agencija za Uzice | Digitalni Marketing | Platinum Zenith', description: 'Marketing agencija za Uzice i Zlatiborski okrug: SEO, Google Ads i kampanje na drustvenim mrezama za lokalne firme i turizam uz merljiv ROI.', keywords: 'marketing agencija uzice, digitalni marketing uzice, seo uzice, izrada sajta uzice, google ads uzice, marketing zlatiborski okrug, zlatibor marketing, tara marketing' },
  '/marketing-agencija-valjevo': { title: 'Marketing Agencija za Valjevo | Digitalni Marketing | Platinum Zenith', description: 'Marketing agencija za Valjevo i Kolubarski okrug: SEO, Google Ads i Meta kampanje za lokalne firme uz merljiv ROI.', keywords: 'marketing agencija valjevo, digitalni marketing valjevo, seo valjevo, izrada sajta valjevo, google ads valjevo, marketing kolubarski okrug, valjevo marketing' },
  '/marketing-agencija-novi-pazar': { title: 'Marketing Agencija za Novi Pazar | Digitalni Marketing | Platinum Zenith', description: 'Marketing agencija za Novi Pazar i Raski okrug: SEO, Google Ads i Meta kampanje za tekstilnu industriju, ugostiteljstvo i lokalne firme.', keywords: 'marketing agencija novi pazar, digitalni marketing novi pazar, seo novi pazar, izrada sajta novi pazar, google ads novi pazar, marketing raski okrug, novi pazar marketing' },
  '/marketing-agencija-sabac': { title: 'Marketing Agencija za Sabac | Digitalni Marketing | Platinum Zenith', description: 'Marketing agencija za Sabac i Macvanski okrug: SEO, Google Ads i Meta kampanje za poljoprivredu, prehrambenu industriju i lokalne firme.', keywords: 'marketing agencija sabac, digitalni marketing sabac, seo sabac, izrada sajta sabac, google ads sabac, marketing macvanski okrug, sabac marketing' },
  '/marketing-agencija-smederevo': { title: 'Marketing Agencija za Smederevo | Digitalni Marketing | Platinum Zenith', description: 'Marketing agencija za Smederevo i Podunavski okrug: SEO, Google Ads i Meta kampanje za industriju, usluzni sektor i lokalne firme.', keywords: 'marketing agencija smederevo, digitalni marketing smederevo, seo smederevo, izrada sajta smederevo, google ads smederevo, marketing podunavski okrug, smederevo marketing' },
  '/marketing-agencija-sremska-mitrovica': { title: 'Marketing Agencija za Sremsku Mitrovicu | Digitalni Marketing | Platinum Zenith', description: 'Marketing agencija za Sremsku Mitrovicu i Sremski okrug: SEO, Google Ads i Meta kampanje za prehrambenu industriju, poljoprivredu i lokalne firme.', keywords: 'marketing agencija sremska mitrovica, digitalni marketing sremska mitrovica, seo sremska mitrovica, izrada sajta sremska mitrovica, google ads sremska mitrovica, marketing sremski okrug, sremska mitrovica marketing' },
  '/marketing-agencija-vranje': { title: 'Marketing Agencija za Vranje | Digitalni Marketing | Platinum Zenith', description: 'Marketing agencija za Vranje i Pcinski okrug: SEO, Google Ads i Meta kampanje za tekstilnu industriju, turizam i lokalne firme na jugu Srbije.', keywords: 'marketing agencija vranje, digitalni marketing vranje, seo vranje, izrada sajta vranje, google ads vranje, marketing pcinski okrug, vranje marketing' },
    '/marketing-agencija-sombor': { title: 'Marketing Agencija za Sombor | Digitalni Marketing | Platinum Zenith', description: 'Marketing agencija za Sombor i Zapadnobacki okrug: SEO, Google Ads i Meta kampanje za lokalne firme u zapadnoj Vojvodini.', keywords: 'marketing agencija sombor, digitalni marketing sombor, seo sombor, izrada sajta sombor, google ads sombor, marketing zapadnobacki okrug, sombor marketing' },
    '/marketing-agencija-pozarevac': { title: 'Marketing Agencija za Pozarevac | Digitalni Marketing | Platinum Zenith', description: 'Marketing agencija za Pozarevac i Branicevski okrug: SEO, Google Ads i Meta kampanje za lokalne firme u istocnoj Srbiji.', keywords: 'marketing agencija pozarevac, digitalni marketing pozarevac, seo pozarevac, izrada sajta pozarevac, google ads pozarevac, marketing branicevski okrug, pozarevac marketing' },
    '/marketing-agencija-jagodina': { title: 'Marketing Agencija za Jagodinu | Digitalni Marketing | Platinum Zenith', description: 'Marketing agencija za Jagodinu i Pomoravski okrug: SEO, Google Ads i Meta kampanje za lokalne firme u centralnoj Srbiji.', keywords: 'marketing agencija jagodina, digitalni marketing jagodina, seo jagodina, izrada sajta jagodina, google ads jagodina, marketing pomoravski okrug, jagodina marketing' },
  ...
  '/google-reklame-cena': { title: 'Google Reklame Cena 2026: CPC, CPA i Budžet | Platinum Zenith', description: 'Google reklame cena u Srbiji 2026: realni CPC i CPA po niši, preporučeni start budžeti i cena vođenja Google Ads kampanja za profitabilan rast.', keywords: 'google reklame cena, google ads cena, koliko kostaju google reklame, cena po kliku google, budzet za google reklame, vodjenje google ads kampanja cena, upravljanje google ads kampanjama' },
  ...
  '/marketing-za-salone-namestaja': {
    ...
    og: { title: 'Marketing za Salone Nameštaja | Platinum Zenith', description: 'Povećajte posete salonu i online prodaju kroz Google Ads, Meta retargeting i SEO optimizaciju za salone nameštaja.' },
    twitter: { title: 'Marketing za Salone Nameštaja | Platinum Zenith', description: 'Povećajte posete salonu i online prodaju kroz Google Ads, Meta retargeting i SEO optimizaciju za salone nameštaja.' },
  },
  '/marketing-za-turisticke-agencije': {
    ...
    keywords: 'marketing za turisticke agencije, digitalni marketing turizam, reklame za putovanja, google ads turizam, social media turisticke agencije',
    og: { title: 'Marketing za Turističke Agencije | Povećajte Broj Rezervacija | PZ', description: 'Digitalni marketing za turističke agencije. Google i Meta kampanje koje donose rane rezervacije, bolji buking i stabilniji rast tokom cele godine.' },
    twitter: { title: 'Marketing za Turističke Agencije | Povećajte Broj Rezervacija | PZ', description: 'Digitalni marketing za turističke agencije. Google i Meta kampanje koje donose rane rezervacije, bolji buking i stabilniji rast tokom cele godine.' },
    type: 'website'
  },
  '/marketing-za-proizvodne-firme': {
    ...
    keywords: 'marketing za proizvodne firme, b2b marketing proizvodnja, industrijski marketing, digitalni marketing za industriju, lead generation proizvodnja',
    og: { title: 'Marketing za Proizvodne Firme | Platinum Zenith', description: 'B2B marketing za proizvodnju i industriju: LinkedIn generisanje leadova, Google Ads i SEO za stabilan rast i predvidljiviji pipeline upita.' },
    twitter: { title: 'Marketing za Proizvodne Firme | Platinum Zenith', description: 'B2B marketing za proizvodnju i industriju: LinkedIn generisanje leadova, Google Ads i SEO za stabilan rast i predvidljiviji pipeline upita.' },
  },
  '/marketing-za-zanatlije': {
    ...
    og: { title: 'Digitalni Marketing za Majstore i Zanatlije | Platinum Zenith', description: 'Digitalni marketing za zanatlije, električare i vodoinstalatere: Google Ads za hitne intervencije, lokalni SEO i sajtovi koji donose više upita.' },
    twitter: { title: 'Digitalni Marketing za Majstore i Zanatlije | Platinum Zenith', description: 'Digitalni marketing za zanatlije, električare i vodoinstalatere: Google Ads za hitne intervencije, lokalni SEO i sajtovi koji donose više upita.' },
  },
  ...
  '/marketing-za-kafice-i-barove': {
    ...
    keywords: 'marketing za kafice, marketing za barove, marketing za kafane, digitalni marketing kafic, google business kafic, instagram reklame bar, lokalni seo kafic, marketing ugostiteljstvo srbija',
    og: { title: 'Marketing za Kafice i Barove u Srbiji | Platinum Zenith', description: 'Marketing za kafice i barove u Srbiji: Google Business optimizacija, Instagram kampanje, lokalni SEO i dogadjaji koji pune stolove svaki dan, ne samo vikendom.' },
    twitter: { title: 'Marketing za Kafice i Barove u Srbiji | Platinum Zenith', description: 'Marketing za kafice i barove u Srbiji: Google Business optimizacija, Instagram kampanje, lokalni SEO i dogadjaji koji pune stolove svaki dan, ne samo vikendom.' },
  },
...
export const pageSchemas = {
  ...
  '/marketing-za-kafice-i-barove': {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": `${SITE_URL}/marketing-za-kafice-i-barove#webpage`,
        "url": `${SITE_URL}/marketing-za-kafice-i-barove`,
        "name": "Marketing za Kafice i Barove u Srbiji | Platinum Zenith",
        "description": "Marketing za kafice i barove u Srbiji: Google Business optimizacija, Instagram kampanje, lokalni SEO i dogadjaji koji pune stolove svaki dan, ne samo vikendom.",
        "isPartOf": { "@id": `${SITE_URL}/#website` },
        "about": { "@id": `${SITE_URL}/marketing-za-kafice-i-barove#service` },
        "breadcrumb": { "@id": `${SITE_URL}/marketing-za-kafice-i-barove#breadcrumb` },
        "mainEntity": [
          { "@id": `${SITE_URL}/marketing-za-kafice-i-barove#service` },
          { "@id": `${SITE_URL}/marketing-za-kafice-i-barove#faq` }
        ],
        "potentialAction": {
          "@type": "ContactAction",
          "name": "Zakazite analizu lokala",
          "target": `${SITE_URL}/kontakt`
        }
      },
      {
        ...
        "url": `${SITE_URL}/marketing-za-kafice-i-barove`,
        "mainEntityOfPage": { "@id": `${SITE_URL}/marketing-za-kafice-i-barove#webpage` },
        "provider": { "@id": `${SITE_URL}/#organization` },
        "areaServed": { "@type": "Country", "name": "Srbija" },
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
          "name": "Marketing usluge za kafice i barove",
          "itemListElement": [
            { "@type": "Offer", "name": "Google Business optimizacija za kafice" },
            { "@type": "Offer", "name": "Instagram i Meta kampanje za lokalni doseg" },
            { "@type": "Offer", "name": "Lokalni SEO za ugostiteljske objekte" },
            { "@type": "Offer", "name": "Sajt i landing stranice za barove" }
          ]
        }
      },
      {
        "@type": "BreadcrumbList",
        "@id": `${SITE_URL}/marketing-za-kafice-i-barove#breadcrumb`,
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Pocetna", "item": SITE_URL },
          { "@type": "ListItem", "position": 2, "name": "Marketing za kafice i barove", "item": `${SITE_URL}/marketing-za-kafice-i-barove` }
        ]
      },
      {
        "@type": "FAQPage",
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Da li se marketing isplati za kafic sa prosecnom potrosnjom od 500 dinara?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Jedan novi redovni gost koji dodje tri puta nedeljno donese 6.000 do 8.000 dinara mesecno. Ako kampanja od 100 evra donese 20 novih redovnih gostiju, to je 120.000 do 160.000 dinara mesecnog prihoda. Marketing se ne meri po jednoj kafi vec po vrednosti redovnog gosta."
            }
          },
          {
            "@type": "Question",
            "name": "Koji kanal je najvazniji za lokalni kafic ili bar?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Google Business profil je najvazniji jer hvata ljude koji aktivno traze kafic u blizini. Instagram je drugi jer gradi svest i prikazuje atmosferu. Idealno je koristiti oba jer pokrivaju razlicite faze odluke."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Google Business optimizacija pocinje da daje rezultate za 2 do 4 nedelje. Instagram kampanje mogu doneti prve nove goste vec u prvoj nedelji ako je kreativ dobar i targetiranje precizno."
            }
          },
          {
            "@type": "Question",
            "name": "Nemamo budzet za veliki marketing, sta je minimum?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Google Business optimizacija je besplatna i daje najveci povrat. Za Instagram reklame, 50 do 100 evra mesecno za lokalni kafic moze biti dovoljno da testirate sta radi. Pocnite sa jednim kanalom i sirite kad vidite rezultat."
            }
          },
          {
            "@type": "Question",
            "name": "Da li nam treba sajt ako imamo Instagram i Google profil?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Za pocetak ne mora. Ali kad zelite da prikazete meni, dogadjaje i primate rezervacije na jednom mestu, jednostavna landing stranica znacajno pomaze. Posebno ako imate dogadjaje ili specijalne ponude koje se menjaju."
            }
          }
        ]
      }

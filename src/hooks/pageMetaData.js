  ...
  '/instagram-reklame-cena': {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "provider": { "@id": `${SITE_URL}#organization`, "@type": "Organization", "name": "Platinum Zenith", "url": SITE_URL },
        "audience": { "@type": "BusinessAudience", "audienceType": "Mala i srednja preduzeca, e-commerce brendovi i usluzne firme u Srbiji" },
        "availableChannel": { "@type": "ServiceChannel", "serviceUrl": `${SITE_URL}/kontakt`, "providesService": { "@type": "Service", "name": "Besplatna procena oglasnog budzeta" } },
        "serviceOutput": { "@type": "Thing", "name": "Stabilan dotok upita, poruka i porudzbina sa Instagrama uz definisan ROAS/CPA." },
        "offers": {
          "@type": "AggregateOffer",
          "priceCurrency": "EUR",
          "lowPrice": "200",

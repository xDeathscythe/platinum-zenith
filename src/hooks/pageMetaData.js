...
export const pageMeta = {
  ...
  '/uslovi-kupovine': { title: 'Uslovi Kupovine | Platinum Zenith', description: 'Sva pravila online kupovine na Platinum Zenith sajtu: poručivanje, cene, odustanak u roku od 14 dana, reklamacije i prava potrošača.', keywords: 'uslovi kupovine, online prodavnica, odustanak od ugovora, reklamacije' },
  '/nacin-placanja': { title: 'Način Plaćanja | Platinum Zenith', description: 'Informacije o dostupnim načinima plaćanja: pouzećem, karticom i uplatom na račun, sigurnost plaćanja i izdavanje računa.', keywords: 'način plaćanja, plaćanje pouzećem, kartično plaćanje, uplata na račun' },
  '/dostava': { title: 'Dostava | Platinum Zenith', description: 'Uslovi dostave za online porudžbine: rokovi obrade i isporuke, trošak dostave, praćenje pošiljke i postupak kod neuspele isporuke.', keywords: 'dostava, rok isporuke, trošak dostave, kurirska služba' },

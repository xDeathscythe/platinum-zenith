/**
 * Page meta hook — lazy loads metadata chunk to reduce initial index bundle.
 */
import { useEffect } from 'react'
import { useLocation } from 'react-router-dom'

const pageMetaModulePromise = import('./pageMetaData.js')

export function preloadPageMeta() {
...
export default function usePageMeta() {
  ...
  useEffect(() => {
    ...
    pageMetaModulePromise.then(({ pageMeta, orgSchema, websiteSchema, pageSchemas, setJsonLd, SITE_URL }) => {
      if (cancelled) return

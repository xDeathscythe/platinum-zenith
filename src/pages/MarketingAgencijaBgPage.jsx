      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
            ...
            <Link to="/marketing-agencija-sombor" className="bg-panel rounded-[14px] border border-edge p-5 hover:border-indigo-500/30 transition-colors">
              <div className="text-[14px] font-medium text-ink mb-1">Marketing agencija Sombor</div>
              <div className="text-[12px] text-ink-3">Digitalni marketing za zapadnu Vojvodinu</div>
            </Link>
            ...
            <Link to="/marketing-agencija-novi-pazar" className="bg-panel rounded-[14px] border border-edge p-5 hover:border-indigo-500/30 transition-colors">
              <div className="text-[14px] font-medium text-ink mb-1">Marketing agencija Novi Pazar</div>
              <div className="text-[12px] text-ink-3">Digitalni marketing za Raski okrug</div>
            </Link>
            <Link to="/marketing-agencija-sremska-mitrovica" className="bg-panel rounded-[14px] border border-edge p-5 hover:border-indigo-500/30 transition-colors">
              ...
              <div className="text-[12px] text-ink-3">Digitalni marketing za Sremski okrug</div>
            </Link>

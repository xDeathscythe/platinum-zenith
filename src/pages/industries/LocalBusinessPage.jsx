        ...
        <div className="max-w-[860px] mx-auto">
          <Reveal className="text-center">
            ...
            <p className="text-[14px] text-ink-3 leading-[24px] max-w-[620px] mx-auto mt-5">
              Ako vodite salon i hocete vise rezervacija umesto samog reach-a, otvorite i <Link to="/marketing-za-frizerske-salone" className="text-ink underline decoration-1 underline-offset-4 hover:opacity-80">marketing za frizerske salone</Link> za lokalni SEO, Instagram i booking funnel strategiju. Za kozmeticke salone sa tretmanima lica i tela, pogledajte <Link to="/marketing-za-kozmeticke-salone" className="text-ink underline decoration-1 underline-offset-4 hover:opacity-80">marketing za kozmeticke salone</Link>. Autoservisi mogu da pogledaju <Link to="/marketing-za-autoservise" className="text-ink underline decoration-1 underline-offset-4 hover:opacity-80">marketing za autoservise</Link> za Google Ads, lokalni SEO i strategije koje pune raspored servisa.
            </p>
          </Reveal>
        </div>
      </section>

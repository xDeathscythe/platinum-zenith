...
export default function AnalyticsPage() {
  ...
  return <div className="text-white space-y-6">
    ...
    <div className="flex flex-wrap gap-4 text-sm"><a className="underline" href="https://search.google.com/search-console?resource_id=sc-domain%3Aplatinumzenith.com" target="_blank" rel="noreferrer">Google upiti i pozicije</a><a className="underline" href="https://analytics.google.com/analytics/web/#/a408050176p554183178/reports/home" target="_blank" rel="noreferrer">Google Analytics: kanali i lokacije</a><a className="underline" href="https://clarity.microsoft.com/projects/view/yilacvvgl0/dashboard" target="_blank" rel="noreferrer">Clarity: snimci i mape klikova</a><button className="underline" onClick={() => csv(data.sources)}>Preuzmi izvore (CSV)</button></div>

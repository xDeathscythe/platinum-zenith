      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 text-[13px]">
            ...
            <Link to="/google-reklame-cena" className="bg-panel rounded-full border border-edge px-4 py-2 text-ink-2 hover:border-ink-4 transition-colors">Google reklame cena →</Link>

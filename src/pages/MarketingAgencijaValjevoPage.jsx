...
const services = [
  ...
  { title: 'SEO optimizacija', desc: 'Pojavite se na vrhu Google pretrage za kljucne reci koje koriste vasi klijenti u Valjevu i Kolubarskom okrugu.', icon: '📈', link: '/seo-optimizacija-cena' },
  { title: 'Google Ads', desc: 'Placeni oglasi sa preciznim targetiranjem na Valjevo i okolinu. Kontrolisan budzet, merljivi rezultati od prvog dana.', icon: '🎯', link: '/google-reklame-cena' },
...
const reasons = [
  { title: 'Poznajemo trziste zapadne Srbije', text: 'Valjevo je centar Kolubarskog okruga sa oko 90.000 stanovnika u gradu i 175.000 u sirem regionu. Ekonomija se oslanja na prehrambenu industriju, metalopreradu, tekstil i rastuce usluzne delatnosti. Marketing strategija za valjevske firme mora da uzme u obzir blizinu Beograda ali i snaznu lokalnu potraznju.' },
  ...
  { title: 'Iskustvo sa razlicitim industrijama', text: 'Od prehrambene industrije i maloprodaje do stomatologa i privatnih klinika. Svaka industrija ima specificne potrebe i mi ih poznajemo iz direktnog iskustva.' },
...
const faqs = [
  { q: 'Zasto bih birao agenciju koja nije iz Valjeva?', a: 'Zato sto kvalitet digitalnog marketinga ne zavisi od fizicke lokacije agencije. Rad se odvija online, rezultati su merljivi, a komunikacija funkcionise jednako dobro preko video poziva kao i uzivo. Bitno je iskustvo i rezultati, ne adresa.' },
  { q: 'Da li radite sa firmama iz Valjeva i okoline?', a: 'Radimo sa firmama iz cele Srbije, ukljucujuci Kolubarski okrug. Imamo iskustva sa razlicitim industrijama prisutnim u Valjevu, od proizvodnje i maloprodaje do usluznih delatnosti i turizma na Divcibarama.' },
  { q: 'Koliko kosta digitalni marketing za firmu u Valjevu?', a: 'Zavisi od obima i potreba. Izrada sajta krece od 300 evra, mesecni SEO od 300 evra, Google Ads od 500 evra sa upravljanjem. Za detalje pogledajte nase stranice o cenama ili nas kontaktirajte za besplatnu procenu.' },
  { q: 'Da li pokrivate okolna mesta poput Lajkovca i Ljiga?', a: 'Naravno. Lokalni SEO i Google Ads kampanje mogu da ciljaju ceo Kolubarski okrug, ukljucujuci Lajkovac, Ljig, Mionica, Osecina i Ub. Za firme koje zavise od lokalne potraznje ovo je kljucno.' },
...
export default function MarketingAgencijaValjevoPage() {
  usePageMeta()
  return (
    <div className="min-h-screen bg-page">
      <section className="relative pt-[140px] md:pt-[180px] pb-16 md:pb-24 px-4 md:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto text-center">
          <span className="inline-block text-[11px] uppercase tracking-[0.2em] text-ink-3 mb-5">Valjevo · Srbija</span>
          <h1 className="text-[32px] md:text-[52px] font-medium leading-[1.1] tracking-[-1px] text-ink mb-5">Marketing agencija za Valjevo</h1>
          <p className="text-[16px] md:text-[18px] text-ink-2 leading-relaxed max-w-[600px] mx-auto mb-8">
            Platinum Zenith pomaze firmama u Valjevu i Kolubarskom okrugu da rastu online. Pravimo sajtove koji prodaju, vodimo kampanje koje donose merljive rezultate i optimizujemo konverzije za lokalne biznise.
          </p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[1100px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-10 text-center">Sta radimo za firme u Valjevu</h2>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto bg-panel rounded-[20px] border border-edge p-6 md:p-8">
          <h2 className="text-[22px] md:text-[26px] font-medium text-ink mb-5">Valjevo u brojevima</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            {[
              { num: '90K+', label: 'Stanovnika grada' },
              { num: '175K+', label: 'Kolubarski okrug' },
              { num: '9K+', label: 'Aktivnih firmi u okrugu' },
              { num: '100km', label: 'Od Beograda' },
            ].map(s => (
              <div key={s.label}>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Marketing kanali za biznise u Valjevu</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Valjevo je grad sa jakom proizvodnom tradicijom i rastucim usluznim sektorom. Digitalna konkurencija je niska, sto znaci da firme koje prve ulazu u online marketing dobijaju veliku prednost na lokalnom trzistu.</p>
          <div className="space-y-6">
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              <h3 className="text-[17px] font-medium text-ink mb-2">Google Ads za Valjevo i Kolubarski okrug</h3>
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Cena po kliku za lokalne pretrage u Valjevu je znatno niza nego u Beogradu. Kampanje mogu da ciljaju i okolna mesta poput Lajkovca, Ljiga, Mionice i Uba. Za usluzne delatnosti i maloprodaju, Google Ads je najbrzi put do novih klijenata koji aktivno pretrazuju vase usluge.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Google Business profil, lokalni sadrzaj i recenzije su kljucni za svaki biznis koji zavisi od lokalnih kupaca. Vecina firmi u Valjevu nema optimizovan profil, sto otvara prostor za brze rezultate onima koji prvi krenu sa SEO optimizacijom.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Vizuelne kampanje za restorane, salone, maloprodaju i lokalne usluge. Valjevo ima rastucu scenu ugostitelja i malih biznisa koji mogu da iskoriste drustvene mreze za privlacenje novih kupaca iz grada i okolnih mesta, ukljucujuci vikend turiste sa Divcibare.</p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Industrije koje pokrivamo u Valjevu</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Specijalizovane strategije za industrije koje dominiraju u Kolubarskom okrugu.</p>
        ...
        <div className="max-w-[760px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link to="/marketing-agencija-uzice" className="bg-panel rounded-[14px] border border-edge p-5 hover:border-indigo-500/30 transition-colors">
              <div className="text-[14px] font-medium text-ink mb-1">Marketing agencija Uzice</div>
      ...
      <section className="px-4 md:px-8 pb-20 md:pb-32">
        <div className="max-w-[600px] mx-auto text-center">
          <h2 className="text-[22px] md:text-[28px] font-medium text-ink mb-4">Spremni za rast u Valjevu?</h2>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@graph": [{
          ...
          "name": "Platinum Zenith - Marketing Agencija Valjevo",
          "url": "https://platinumzenith.com/marketing-agencija-valjevo",
          "telephone": "+381668168929",
          "email": "aleksandar@platinumzenith.com",
          "areaServed": { "@type": "City", "name": "Valjevo" },
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Marketing agencija Valjevo", "item": "https://platinumzenith.com/marketing-agencija-valjevo" }
          ]
        }]
      })}} />
    </div>

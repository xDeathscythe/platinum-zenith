...
const services = [
  { title: 'Izrada sajtova', desc: 'Profesionalan sajt koji pretvara posetioce u kupce. Brz, mobile-first, optimizovan za Google od starta.', icon: '🌐', link: '/web-design' },
  { title: 'SEO optimizacija', desc: 'Pojavite se na vrhu Google pretrage za kljucne reci koje koriste vasi klijenti u Subotici i Vojvodini.', icon: '📈', link: '/seo-optimizacija-cena' },
  { title: 'Google Ads', desc: 'Placeni oglasi sa preciznim targetiranjem na Suboticu i severnu Backu. Svaki dinar se vraca kroz prodaju.', icon: '🎯', link: '/google-reklame-cena' },
...
const reasons = [
  { title: 'Razumemo specificnosti severne Vojvodine', text: 'Subotica je multijezicni grad na granici sa Madjarskom i EU. Marketing koji radi u Beogradu nije isti za Suboticu gde postoji dvojezicna publika, prigranican promet i specificna privredna struktura.' },
...
const faqs = [
  { q: 'Zasto bih birao agenciju koja nije iz Subotice?', a: 'Zato sto kvalitet digitalnog marketinga ne zavisi od fizicke lokacije agencije. Rad se odvija online, rezultati su merljivi, a komunikacija funkcionise jednako dobro preko video poziva kao i uzivo.' },
  { q: 'Da li radite sa firmama iz Subotice?', a: 'Radimo sa firmama iz cele Srbije, ukljucujuci severnu Vojvodinu. Komunikacija je online, sastanci su preko video poziva, a rezultati su merljivi bez obzira na geografsku udaljenost.' },
  { q: 'Koliko kosta digitalni marketing za firmu u Subotici?', a: 'Zavisi od obima. Izrada sajta krece od 300 evra, mesecni SEO od 300 evra, Google Ads od 500 evra sa upravljanjem. Za detalje pogledajte nase stranice o cenama ili nas kontaktirajte.' },
  { q: 'Da li mozete da radite kampanje i na madjarskom jeziku?', a: 'Mozemo da prilagodimo kampanje za dvojezicnu publiku u Subotici. Lokalni SEO i oglasi na madjarskom jeziku pomazu da dopremo do svih potencijalnih klijenata u vasem gradu.' },
...
export default function MarketingAgencijaSuboticaPage() {
  usePageMeta()
  return (
    <div className="min-h-screen bg-page">
      <section className="relative pt-[140px] md:pt-[180px] pb-16 md:pb-24 px-4 md:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto text-center">
          <span className="inline-block text-[11px] uppercase tracking-[0.2em] text-ink-3 mb-5">Subotica · Srbija</span>
          <h1 className="text-[32px] md:text-[52px] font-medium leading-[1.1] tracking-[-1px] text-ink mb-5">Marketing agencija za Suboticu</h1>
          <p className="text-[16px] md:text-[18px] text-ink-2 leading-relaxed max-w-[600px] mx-auto mb-8">
            Platinum Zenith pomaze firmama u Subotici i severnoj Vojvodini da rastu online. Pravimo sajtove koji prodaju, vodimo kampanje koje donose merljive rezultate i optimizujemo konverzije za lokalne biznise.
          </p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[1100px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-10 text-center">Sta radimo za firme u Subotici</h2>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto bg-panel rounded-[20px] border border-edge p-6 md:p-8">
          <h2 className="text-[22px] md:text-[26px] font-medium text-ink mb-5">Subotica u brojevima</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            {[
              { num: '140K+', label: 'Stanovnika' },
              { num: '5.', label: 'Najveci grad u Srbiji' },
              { num: '20K+', label: 'Aktivnih firmi u okrugu' },
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Marketing kanali za biznise u Subotici</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Konkurencija u online prostoru u Subotici je i dalje mala u poredjenju sa Beogradom. To je prednost za firme koje krenu prve sa ozbiljnim digitalnim marketingom.</p>
          <div className="space-y-6">
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              <h3 className="text-[17px] font-medium text-ink mb-2">Google Ads za Suboticu i severnu Backu</h3>
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Cena po kliku za lokalne pretrage u Subotici je znatno niza nego u Beogradu. Za istu investiciju dobijate vise klikova, vise poziva i vise upita. Dodatna prednost: prigranican promet iz Madjarske koji pretrazuje na srpskom.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Google Business profil, lokalni sadrzaj i recenzije su kljucni za svaki biznis koji zavisi od lokalnih kupaca. Vecina subotuckih firmi nema optimizovan profil, sto znaci da je prostor za brze rezultate otvoren.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Vizuelne kampanje za restorane, salone, klinike i maloprodaju. Subotica ima aktivnu publiku na drustvenim mrezama, posebno na Instagram-u i Facebook-u gde lokalni biznisi mogu brzo da izgrade praticce.</p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Industrije koje pokrivamo u Subotici</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Specijalizovane strategije za industrije koje dominiraju u severnoj Vojvodini.</p>
      ...
      <section className="px-4 md:px-8 pb-20 md:pb-32">
        <div className="max-w-[600px] mx-auto text-center">
          <h2 className="text-[22px] md:text-[28px] font-medium text-ink mb-4">Spremni za rast u Subotici?</h2>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@graph": [{
          ...
          "name": "Platinum Zenith - Marketing Agencija Subotica",
          "url": "https://platinumzenith.com/marketing-agencija-subotica",
          "telephone": "+381668168929",
          "email": "aleksandar@platinumzenith.com",
          "areaServed": { "@type": "City", "name": "Subotica" },
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Marketing agencija Subotica", "item": "https://platinumzenith.com/marketing-agencija-subotica" }
          ]
        }]
      })}} />
    </div>

...
export default function SocialMediaPage() {
  return (
    <>
      <PageMeta title="Upravljanje Drustvenim Mrezama" description="Profesionalno vodjenje Instagram, Facebook, TikTok i LinkedIn naloga za vase poslovanje. Strategija sadrzaja, rast pratilaca i angazovanje publike." />
      {/* ─── Hero ─── */}
      <section className="relative flex flex-col items-center text-center pt-[200px] md:pt-[260px] pb-[80px] md:pb-[120px] px-4 md:px-8 overflow-hidden min-h-[70vh]">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-x-0 z-[1]"
            style={{ top: '64vh', height: '52vh', backdropFilter: 'blur(68px)', WebkitBackdropFilter: 'blur(68px)', maskImage: 'linear-gradient(to bottom, transparent 0%, black 20%, black 82%, transparent 100%)', WebkitMaskImage: 'linear-gradient(to bottom, transparent 0%, black 20%, black 82%, transparent 100%)' }}
          />
          <div className="absolute inset-0 z-[2] only-dark"
            style={{ background: 'linear-gradient(to bottom, rgba(0,0,0,0) 50%, rgba(0,0,0,0.30) 65%, rgba(0,0,0,0.70) 80%, #000000 95%)' }}
          />
          <div className="absolute inset-0 z-[2] only-light"
            style={{ background: 'linear-gradient(to bottom, rgba(255,255,255,0) 50%, rgba(255,255,255,0.35) 65%, rgba(255,255,255,0.75) 80%, #ffffff 95%)' }}
          />
        </div>

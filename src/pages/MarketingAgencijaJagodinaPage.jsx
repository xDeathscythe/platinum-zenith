...
const services = [
  ...
  { title: 'SEO optimizacija', desc: 'Pojavite se na vrhu Google pretrage za kljucne reci koje koriste vasi klijenti u Jagodini i Pomoravskom okrugu.', icon: '📈', link: '/seo-optimizacija-cena' },
  { title: 'Google Ads', desc: 'Placeni oglasi sa preciznim targetiranjem na Jagodinu i okolinu. Kontrolisan budzet, merljivi rezultati od prvog dana.', icon: '🎯', link: '/google-reklame-cena' },
...
const reasons = [
  { title: 'Poznajemo trziste centralne Srbije', text: 'Jagodina je centar Pomoravskog okruga sa oko 71.000 stanovnika i ekonomijom koja obuhvata prehrambenu industriju, maloprodaju, poljoprivredu i usluzni sektor. Marketing strategija za ovaj region mora da uzme u obzir specificnosti grada koji ulaze u turizam, kulturne sadrzaje i infrastrukturu.' },
  ...
  { title: 'Iskustvo sa razlicitim industrijama', text: 'Od prehrambene industrije i poljoprivrede do ugostiteljstva i turizma. Svaka industrija ima specificne potrebe i mi ih poznajemo iz direktnog iskustva.' },
...
const faqs = [
  { q: 'Zasto bih birao agenciju koja nije iz Jagodine?', a: 'Zato sto kvalitet digitalnog marketinga ne zavisi od fizicke lokacije agencije. Rad se odvija online, rezultati su merljivi, a komunikacija funkcionise jednako dobro preko video poziva kao i uzivo. Bitno je iskustvo i rezultati, ne adresa.' },
  { q: 'Da li radite sa firmama iz Jagodine i okoline?', a: 'Radimo sa firmama iz cele Srbije, ukljucujuci Pomoravski okrug. Imamo iskustva sa razlicitim industrijama prisutnim u Jagodini, od prehrambene industrije i poljoprivrede do ugostiteljstva i maloprodaje.' },
  { q: 'Koliko kosta digitalni marketing za firmu u Jagodini?', a: 'Zavisi od obima i potreba. Izrada sajta krece od 300 evra, mesecni SEO od 300 evra, Google Ads od 500 evra sa upravljanjem. Za detalje pogledajte nase stranice o cenama ili nas kontaktirajte za besplatnu procenu.' },
  { q: 'Da li pokrivate okolna mesta poput Cuprije, Svilajnca i Despotovca?', a: 'Naravno. Lokalni SEO i Google Ads kampanje mogu da ciljaju ceo Pomoravski okrug, ukljucujuci Cupriju, Svilajnac, Despotovac, Rekovac i Paracin. Za firme koje zavise od lokalne potraznje ovo je kljucno.' },
...
export default function MarketingAgencijaJagodinaPage() {
  usePageMeta()
  return (
    <div className="min-h-screen bg-page">
      <section className="relative pt-[140px] md:pt-[180px] pb-16 md:pb-24 px-4 md:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto text-center">
          <span className="inline-block text-[11px] uppercase tracking-[0.2em] text-ink-3 mb-5">Jagodina · Srbija</span>
          <h1 className="text-[32px] md:text-[52px] font-medium leading-[1.1] tracking-[-1px] text-ink mb-5">Marketing agencija za Jagodinu</h1>
          <p className="text-[16px] md:text-[18px] text-ink-2 leading-relaxed max-w-[600px] mx-auto mb-8">
            Platinum Zenith pomaze firmama u Jagodini i Pomoravskom okrugu da rastu online. Pravimo sajtove koji prodaju, vodimo kampanje koje donose merljive rezultate i optimizujemo konverzije za lokalne biznise.
          </p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[1100px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-10 text-center">Sta radimo za firme u Jagodini</h2>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto bg-panel rounded-[20px] border border-edge p-6 md:p-8">
          <h2 className="text-[22px] md:text-[26px] font-medium text-ink mb-5">Jagodina u brojevima</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            {[
              { num: '40K+', label: 'Stanovnika grada' },
              { num: '71K+', label: 'Opstina Jagodina' },
              { num: '210K+', label: 'Pomoravski okrug' },
              { num: '135km', label: 'Od Beograda' },
            ].map(s => (
              <div key={s.label}>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Marketing kanali za biznise u Jagodini</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Jagodina je centar Pomoravskog okruga i jedan od najdinamicnijih gradova centralne Srbije. Poznata po zoo vrtu, akva parku, muzeju vostanik figura i jakoj prehrambeno-preradvackoj industriji, grad ulaze u turizam i kulturne sadrzaje vec godinama. Autoput Beograd-Nis prolazi kroz Jagodinu, sto je cini strateskim logistickim cvoristem. Digitalni marketing je jos uvek nedovoljno iskoriscen kod vecine lokalnih firmi, sto otvara prostor za rane pokretace.</p>
          <div className="space-y-6">
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              <h3 className="text-[17px] font-medium text-ink mb-2">Google Ads za Jagodinu i Pomoravski okrug</h3>
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Cena po kliku za lokalne pretrage u Jagodini je znacajno niza od beogradskog proseka, a konkurencija u online oglasavanju je minimalna. Kampanje mogu da ciljaju i okolna mesta poput Cuprije, Paracina, Svilajnca i Despotovca. Za prehrambenu industriju, maloprodaju, ugostiteljstvo i usluzne delatnosti, Google Ads je najbrzi nacin da dodju do novih kupaca koji vec pretrazuju njihove usluge.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Google Business profil, lokalni sadrzaj i recenzije su kljucni za svaki biznis koji zavisi od lokalnih kupaca. Jagodina ima rastuci broj pretraga za lokalne usluge, posebno u ugostiteljstvu, zdravstvu, zanatstvu i turizmu. Zoo vrt i akva park privlace posetioce iz cele Srbije, a firme koje imaju optimizovan profil hvataju taj saobracaj.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Vizuelne kampanje za restorane, salone, maloprodaju i lokalne usluge. Jagodina ima bogatu turisticku ponudu zahvaljujuci zoo vrtu, akva parku, muzeju vostanik figura i etno selu. Za firme koje prodaju online ili privlace turiste, Meta Ads omogucava precizno ciljanje stanovnika Jagodine i posetilaca iz celog Pomoravskog okruga.</p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Industrije koje pokrivamo u Jagodini</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Specijalizovane strategije za industrije koje dominiraju u Pomoravskom okrugu.</p>
      ...
      <section className="px-4 md:px-8 pb-20 md:pb-32">
        <div className="max-w-[600px] mx-auto text-center">
          <h2 className="text-[22px] md:text-[28px] font-medium text-ink mb-4">Spremni za rast u Jagodini?</h2>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@graph": [{
          ...
          "name": "Platinum Zenith - Marketing Agencija Jagodina",
          "url": "https://platinumzenith.com/marketing-agencija-jagodina",
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Marketing agencija Jagodina", "item": "https://platinumzenith.com/marketing-agencija-jagodina" }
          ]
        }]
      })}} />
    </div>

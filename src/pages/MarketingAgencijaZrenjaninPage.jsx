      ...
      <section className="relative pt-[140px] md:pt-[180px] pb-16 md:pb-24 px-4 md:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link to="/studije-slucaja" className="inline-flex items-center gap-2 text-ink-2 text-[14px] font-medium h-11 px-6 rounded-full border border-edge hover:bg-tint transition-colors">

...
const challenges = [
  ...
  },
  {
    ...
    desc: 'Novih privatnih skola, kurseva i akademija je sve vise. Bez jasne razlike u ponudi i vidljivosti na Google-u i mrezi, svodite se na jos jednu opciju u nizu.',
  },
  {
    icon: '04',
...
const playbook = [
  {
    ...
    desc: 'Kada neko trazi privatnu skolu u svom gradu, kurs engleskog za dete ili autoskolu sa dobrim prolazom, vec je u fazi odluke. Placena pretraga stavlja vas na vrh tog trenutka.',
    items: [
  ...
  },
  {
    ...
    desc: 'Roditelj koji jos ne trazi aktivno skolu moze da vas primeti kroz sadrzaj koji pokazuje kako izgleda cas, kakav je pristup i kakve rezultate postizete.',
    items: [
      'Video sadrzaj iz ucionice, radionice i dogadjaja koji grade poverenje',
  ...
  },
  {
    ...
    items: [
      ...
      'Stranica za svaki kurs ili nivo sa konkretnim sadrzajem programa',
  ...
  },
  {
    ...
    desc: 'Vecina roditelja trazi skolu u svom kraju. Google mapa i lokalni rezultati su mesto gde se donosi odluka, cesto pre nego sto otvore vas sajt.',
    items: [
      ...
      'Lokalni SEO sadrzaj za grad, naselje i tip obrazovanja',
...
const firstMonth = [
  ...
  {
    title: 'Nedelja 4',
    text: 'Merimo cenu po upitu, kvalitet kontakata i donosimo plan za naredna dva meseca sa budzetom koji ima smisla za vas kapacitet.',
  },
]
...
const relatedLinks = [
  {
    ...
    desc: 'Koliki budzet ima smisla za Google kampanje privatne skole, koje kljucne reci donose upise i kako meriti rezultat.',
  },
  {
  ...
  },
  {
    ...
    desc: 'Koliko kosta da uhvatite polaznike koji traze autoskolu u svom gradu kroz Google reklame.',
  },
  {
    to: '/seo-optimizacija-cena',
    title: 'SEO optimizacija cena',
    desc: 'Za skole koje hoce organski priliv kroz Google pretragu i mapu bez placenih oglasa.',
  },
  {
    ...
    <div className="min-h-screen bg-page">
      <section className="relative pt-[140px] md:pt-[180px] pb-16 md:pb-24 px-4 md:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[860px] mx-auto text-center">
          ...
          <p className="text-[16px] md:text-[18px] text-ink-2 leading-relaxed max-w-[700px] mx-auto mb-8">
            Privatna skola, skola stranih jezika ili autoskola ne rastu jer snize cenu ili objave jos jednu sliku sa casa. Rastu kada roditelji i polaznici lako pronadju informacije, steknu poverenje i zakazu probni cas.
          </p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[1100px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-3 text-center">Zasto je marketing za obrazovanje drugaciji</h2>
      ...
      <section id="plan" className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[920px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-3 text-center">Sta najcesce radi za skole, kurseve i autoskole</h2>
          <p className="text-[15px] text-ink-3 mb-10 text-center max-w-[670px] mx-auto">
            Krecemo od kanala i aktivnosti koji realno donose vise upisa i bolji kvalitet polaznika. Pristup prilagodjavamo tipu institucije i kapacitetu.
          </p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[780px] mx-auto bg-gradient-to-br from-indigo-500/[0.10] to-purple-500/[0.08] rounded-[20px] border border-indigo-500/[0.14] p-6 md:p-8 text-center">
          ...
          <p className="text-[15px] text-ink-2 leading-relaxed max-w-[620px] mx-auto mb-5">
            Pregledamo Google profil, sajt, recenzije, ponudu i nacin upisa. Dobijate konkretan spisak sledecih koraka za vise upisa i bolje popunjene grupe.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            <Link to="/kontakt" className="inline-flex items-center gap-2 bg-inv-bg text-inv-fg text-[14px] font-medium h-11 px-6 rounded-full hover:bg-inv-bg-hover transition-colors">
              Zakazite analizu
      ...
      <section className="px-4 md:px-8 pb-20 md:pb-32">
        <div className="max-w-[620px] mx-auto text-center">
          ...
          <p className="text-[15px] text-ink-2 mb-6">
            Ako hocete vise upisa bez bacanja budzeta na prazne klikove, javite se. Slozicemo plan za vas tip institucije, grad i kapacitet grupa.
          </p>
          <Link to="/kontakt" className="inline-flex items-center gap-2 bg-inv-bg text-inv-fg text-[14px] font-medium h-11 px-6 rounded-full hover:bg-inv-bg-hover transition-colors">
            Kontaktirajte nas
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>

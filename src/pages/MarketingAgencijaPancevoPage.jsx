...
const services = [
  { title: 'Izrada sajtova', desc: 'Brz, mobile-first sajt koji pretvara posetioce u kupce. Optimizovan za Google pretrazivanje od prvog dana.', icon: '🌐', link: '/web-design' },
  { title: 'SEO optimizacija', desc: 'Pojavite se na vrhu Google pretrage za kljucne reci koje koriste vasi klijenti u Pancevu i juznom Banatu.', icon: '📈', link: '/seo-optimizacija-cena' },
  { title: 'Google Ads', desc: 'Placeni oglasi sa preciznim targetiranjem na Pancevo i okolinu. Svaki dinar se vraca kroz prodaju.', icon: '🎯', link: '/google-reklame-cena' },
  { title: 'Drustvene mreze', desc: 'Strategija i oglasi na Facebook-u i Instagram-u koji privlace lokalne kupce i donose upite.', icon: '📱', link: '/drustvene-mreze' },
  { title: 'CRO optimizacija', desc: 'Povecajte procenat posetilaca koji kupe ili posalju upit. Male izmene na sajtu, velika razlika u prihodu.', icon: '⚡', link: '/cro' },
  { title: 'Konsalting', desc: 'Strucan savet i jasan plan za digitalni rast. Ponekad nije potrebna cela agencija, dovoljan je dobar plan.', icon: '💡', link: '/consulting' },
]

const reasons = [
  { title: 'Blizina Beograda je prednost, ne ogranicenje', text: 'Pancevo je na 18 km od centra Beograda, ali ima svoju specificnu ekonomiju i lokalnu publiku. Marketing koji radi za beogradske firme ne pokriva pancev automatski. Potreban je lokalni pristup za grad koji ima i industrijski i usluzni sektor.' },
  ...
  { title: 'Rezultati merljivi brojevima', text: 'Svaki mesec dobijate izvestaj sa konkretnim podacima: saobracaj, konverzije, prihod od kampanja. Bez praznih obecanja.' },
  { title: 'Iskustvo sa razlicitim industrijama', text: 'Od restorana i stomatologa do advokata i kozmetickih salona. Svaka industrija ima specificne potrebe i mi ih poznajemo iz iskustva.' },
  { title: 'Sve pod jednim krovom', text: 'Sajt, SEO, oglasi, drustvene mreze, CRO. Jedna agencija umesto koordinacije vise freelancera i dobavljaca.' },
]

const faqs = [
  { q: 'Zasto bih birao agenciju koja nije iz Panceva?', a: 'Zato sto kvalitet digitalnog marketinga ne zavisi od fizicke lokacije agencije. Rad se odvija online, rezultati su merljivi, a komunikacija funkcionise jednako dobro preko video poziva kao i uzivo.' },
  { q: 'Da li radite sa firmama iz Panceva?', a: 'Radimo sa firmama iz cele Srbije, ukljucujuci juzni Banat. Komunikacija je online, sastanci su preko video poziva, a rezultati su merljivi bez obzira na geografsku udaljenost.' },
  { q: 'Koliko kosta digitalni marketing za firmu u Pancevu?', a: 'Zavisi od obima. Izrada sajta krece od 300 evra, mesecni SEO od 300 evra, Google Ads od 500 evra sa upravljanjem. Za detalje pogledajte nase stranice o cenama ili nas kontaktirajte.' },
  { q: 'Da li pokrivate i okolna mesta poput Starceva i Omoljice?', a: 'Naravno. Lokalni SEO i Google Ads kampanje mogu da ciljaju ceo juzni Banat, ukljucujuci Starcevo, Omoljicu, Opovo i Kovin. Podesavamo radijus prema vasim potrebama.' },
...
export default function MarketingAgencijaPancevoPage() {
  usePageMeta()
  return (
    <div className="min-h-screen bg-page">
      <section className="relative pt-[140px] md:pt-[180px] pb-16 md:pb-24 px-4 md:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto text-center">
          <span className="inline-block text-[11px] uppercase tracking-[0.2em] text-ink-3 mb-5">Pancevo · Srbija</span>
          <h1 className="text-[32px] md:text-[52px] font-medium leading-[1.1] tracking-[-1px] text-ink mb-5">Marketing agencija za Pancevo</h1>
          <p className="text-[16px] md:text-[18px] text-ink-2 leading-relaxed max-w-[600px] mx-auto mb-8">
            Platinum Zenith pomaze firmama u Pancevu i juznom Banatu da rastu online. Pravimo sajtove koji prodaju, vodimo kampanje koje donose merljive rezultate i optimizujemo konverzije za lokalne biznise.
          </p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[1100px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-10 text-center">Sta radimo za firme u Pancevu</h2>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto bg-panel rounded-[20px] border border-edge p-6 md:p-8">
          <h2 className="text-[22px] md:text-[26px] font-medium text-ink mb-5">Pancevo u brojevima</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            {[
              { num: '120K+', label: 'Stanovnika' },
              { num: '18km', label: 'Od centra Beograda' },
              { num: '15K+', label: 'Aktivnih firmi u okrugu' },
              { num: '71%', label: 'Pretrazuje lokalno sa telefona' },
            ].map(s => (
              <div key={s.label}>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Marketing kanali za biznise u Pancevu</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Pancevo ima specifican polozaj: dovoljno blizu Beograda da privuce promet, ali sa sopstvenom lokalnom publikom koja pretrazuje po gradu. Firme koje rano ulaze u digitalni marketing ovde imaju prednost.</p>
          <div className="space-y-6">
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              <h3 className="text-[17px] font-medium text-ink mb-2">Google Ads za Pancevo i juzni Banat</h3>
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Cena po kliku za lokalne pretrage u Pancevu je niza nego u Beogradu, ali publika je kupovno aktivna. Preciznim targetiranjem na Pancevo, Starcevo i okolinu dobijate kvalifikovane upite bez placanja za ceo BG region.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Google Business profil, lokalni sadrzaj i recenzije su kljucni za svaki biznis koji zavisi od lokalnih kupaca. Vecina pancevackih firmi nema optimizovan profil, sto znaci da je prostor za brze rezultate otvoren.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Vizuelne kampanje za restorane, salone, klinike i maloprodaju. Pancevo ima aktivnu zajednicu na drustvenim mrezama, posebno na Instagram-u gde lokalni biznisi brzo grade bazu pratilaca.</p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Industrije koje pokrivamo u Pancevu</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Specijalizovane strategije za industrije zastupljene u juznom Banatu.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              { title: 'Autoservisi', link: '/marketing-za-autoservise', desc: 'Google Ads i lokalni SEO za nove musterije' },
      ...
      <section className="px-4 md:px-8 pb-20 md:pb-32">
        <div className="max-w-[600px] mx-auto text-center">
          <h2 className="text-[22px] md:text-[28px] font-medium text-ink mb-4">Spremni za rast u Pancevu?</h2>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@graph": [{
          ...
          "name": "Platinum Zenith - Marketing Agencija Pancevo",
          "url": "https://platinumzenith.com/marketing-agencija-pancevo",
          "telephone": "+381668168929",
          "email": "aleksandar@platinumzenith.com",
          "areaServed": { "@type": "City", "name": "Pancevo" },
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Marketing agencija Pancevo", "item": "https://platinumzenith.com/marketing-agencija-pancevo" }
          ]
        }]
      })}} />
    </div>

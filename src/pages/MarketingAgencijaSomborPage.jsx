...
const services = [
  ...
  { title: 'SEO optimizacija', desc: 'Pojavite se na vrhu Google pretrage za kljucne reci koje koriste vasi klijenti u Somboru i Zapadnobackom okrugu.', icon: '📈', link: '/seo-optimizacija-cena' },
  { title: 'Google Ads', desc: 'Placeni oglasi sa preciznim targetiranjem na Sombor i okolinu. Kontrolisan budzet, merljivi rezultati od prvog dana.', icon: '🎯', link: '/google-reklame-cena' },
...
const reasons = [
  { title: 'Poznajemo trziste zapadne Vojvodine', text: 'Sombor je centar Zapadnobackog okruga sa oko 85.000 stanovnika i ekonomijom koja spaja poljoprivredu, prehrambenu industriju i usluzni sektor. Marketing strategija mora da reflektuje specificnosti grada poznatog po zelenilu, konjickom sportu i rastucem IT sektoru, sa znacajnim protokom ljudi iz okolnih mesta poput Apatina, Odzaka i Kule.' },
  ...
  { title: 'Iskustvo sa razlicitim industrijama', text: 'Od poljoprivrede i prehrambene industrije do zdravstvenih ustanova i ugostiteljstva. Svaka industrija ima specificne potrebe i mi ih poznajemo iz direktnog iskustva.' },
...
const faqs = [
  { q: 'Zasto bih birao agenciju koja nije iz Sombora?', a: 'Zato sto kvalitet digitalnog marketinga ne zavisi od fizicke lokacije agencije. Rad se odvija online, rezultati su merljivi, a komunikacija funkcionise jednako dobro preko video poziva kao i uzivo. Bitno je iskustvo i rezultati, ne adresa.' },
  { q: 'Da li radite sa firmama iz Sombora i okoline?', a: 'Radimo sa firmama iz cele Srbije, ukljucujuci Zapadnobacki okrug. Imamo iskustva sa razlicitim industrijama prisutnim u Somboru, od poljoprivrede i prehrambene industrije do turizma i maloprodaje.' },
  { q: 'Koliko kosta digitalni marketing za firmu u Somboru?', a: 'Zavisi od obima i potreba. Izrada sajta krece od 300 evra, mesecni SEO od 300 evra, Google Ads od 500 evra sa upravljanjem. Za detalje pogledajte nase stranice o cenama ili nas kontaktirajte za besplatnu procenu.' },
  { q: 'Da li pokrivate okolna mesta poput Apatina, Odzaka i Kule?', a: 'Naravno. Lokalni SEO i Google Ads kampanje mogu da ciljaju ceo Zapadnobacki okrug, ukljucujuci Apatin, Odzake, Kulu, Bac i Bezdan. Za firme koje zavise od lokalne potraznje ovo je kljucno.' },
...
export default function MarketingAgencijaSomborPage() {
  usePageMeta()
  return (
    <div className="min-h-screen bg-page">
      <section className="relative pt-[140px] md:pt-[180px] pb-16 md:pb-24 px-4 md:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto text-center">
          <span className="inline-block text-[11px] uppercase tracking-[0.2em] text-ink-3 mb-5">Sombor · Srbija</span>
          <h1 className="text-[32px] md:text-[52px] font-medium leading-[1.1] tracking-[-1px] text-ink mb-5">Marketing agencija za Sombor</h1>
          <p className="text-[16px] md:text-[18px] text-ink-2 leading-relaxed max-w-[600px] mx-auto mb-8">
            Platinum Zenith pomaze firmama u Somboru i Zapadnobackom okrugu da rastu online. Pravimo sajtove koji prodaju, vodimo kampanje koje donose merljive rezultate i optimizujemo konverzije za lokalne biznise.
          </p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[1100px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-10 text-center">Sta radimo za firme u Somboru</h2>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto bg-panel rounded-[20px] border border-edge p-6 md:p-8">
          <h2 className="text-[22px] md:text-[26px] font-medium text-ink mb-5">Sombor u brojevima</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            {[
              { num: '85K+', label: 'Stanovnika grada' },
              { num: '188K+', label: 'Zapadnobacki okrug' },
              { num: '6K+', label: 'Aktivnih firmi u okrugu' },
              { num: '178km', label: 'Od Beograda' },
            ].map(s => (
              <div key={s.label}>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Marketing kanali za biznise u Somboru</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Sombor je jedan od najzelenijih gradova u Srbiji i administrativni centar Zapadnobackog okruga. Poznat po konjickom sportu, visokom obrazovanju (Pedagoski fakultet) i razvijenoj poljoprivredi, grad ima stabilnu ekonomsku bazu sa rastucim usluznim sektorom. Blizina granice sa Madjarskom i Hrvatskom otvara mogucnosti za cross-border biznis i turizam. Firme koje ulazu u online prisustvo dobijaju prednost nad konkurencijom koja jos uvek radi iskljucivo offline.</p>
          <div className="space-y-6">
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              <h3 className="text-[17px] font-medium text-ink mb-2">Google Ads za Sombor i Zapadnobacki okrug</h3>
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Cena po kliku za lokalne pretrage u Somboru je znacajno niza od beogradskog proseka, a konkurencija u online oglasavanju je minimalna. Kampanje mogu da ciljaju i okolna mesta poput Apatina, Odzaka, Kule i Bezdana. Za poljoprivredne firme, prehrambenu industriju, zanatlije i usluzne delatnosti, Google Ads je najbrzi nacin da dodju do novih kupaca koji vec pretrazuju njihove usluge.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Google Business profil, lokalni sadrzaj i recenzije su kljucni za svaki biznis koji zavisi od lokalnih kupaca. Sombor ima rastuci broj pretraga za lokalne usluge, posebno u zdravstvu, ugostiteljstvu i zanatstvu. Vecina firmi nema optimizovan Google profil, sto ostavlja prostor za brze rezultate onima koji prvi krenu sa SEO optimizacijom.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Vizuelne kampanje za restorane, salone, maloprodaju i lokalne usluge. Somborska kulturna scena, konjicki klub i sezonski dogadjaji su odlicne prilike za kampanje koje privlace posetioce iz celog Zapadnobackog okruga. Za firme koje prodaju online, Meta Ads omogucava precizno ciljanje stanovnika Sombora i okolnih mesta ukljucujuci Apatin na Dunavu.</p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Industrije koje pokrivamo u Somboru</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Specijalizovane strategije za industrije koje dominiraju u Zapadnobackom okrugu.</p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link to="/marketing-agencija-sremska-mitrovica" className="bg-panel rounded-[14px] border border-edge p-5 hover:border-indigo-500/30 transition-colors">
              <div className="text-[14px] font-medium text-ink mb-1">Marketing agencija Sremska Mitrovica</div>
              <div className="text-[12px] text-ink-3">Digitalni marketing za Srem</div>
            </Link>
      ...
      <section className="px-4 md:px-8 pb-20 md:pb-32">
        <div className="max-w-[600px] mx-auto text-center">
          <h2 className="text-[22px] md:text-[28px] font-medium text-ink mb-4">Spremni za rast u Somboru?</h2>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@graph": [{
          ...
          "name": "Platinum Zenith - Marketing Agencija Sombor",
          "url": "https://platinumzenith.com/marketing-agencija-sombor",
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Marketing agencija Sombor", "item": "https://platinumzenith.com/marketing-agencija-sombor" }
          ]
        }]
      })}} />
    </div>

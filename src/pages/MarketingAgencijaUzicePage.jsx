...
const services = [
  ...
  { title: 'SEO optimizacija', desc: 'Pojavite se na vrhu Google pretrage za kljucne reci koje koriste vasi klijenti u Uzicu i Zlatiborskom okrugu.', icon: '📈', link: '/seo-optimizacija-cena' },
  { title: 'Google Ads', desc: 'Placeni oglasi sa preciznim targetiranjem na Uzice i okolinu. Kontrolisan budzet, merljivi rezultati od prvog dana.', icon: '🎯', link: '/google-reklame-cena' },
...
const reasons = [
  { title: 'Poznajemo trziste zapadne Srbije', text: 'Uzice je centar Zlatiborskog okruga sa oko 78.000 stanovnika u gradu i 300.000 u sirem regionu. Ekonomija se oslanja na preradu metala, drvnu industriju, turizam i poljoprivredu. Marketing strategija mora da uzme u obzir ove specificnosti i sezonske varijacije vezane za turizam na Zlatiboru i Tari.' },
  ...
  { title: 'Iskustvo sa razlicitim industrijama', text: 'Od turizma i ugostiteljstva do stomatologa i proizvodjaca. Svaka industrija ima specificne potrebe i mi ih poznajemo iz direktnog iskustva.' },
...
const faqs = [
  { q: 'Zasto bih birao agenciju koja nije iz Uzica?', a: 'Zato sto kvalitet digitalnog marketinga ne zavisi od fizicke lokacije agencije. Rad se odvija online, rezultati su merljivi, a komunikacija funkcionise jednako dobro preko video poziva kao i uzivo. Bitno je iskustvo i rezultati, ne adresa.' },
  { q: 'Da li radite sa firmama iz Uzica i sa Zlatibora?', a: 'Radimo sa firmama iz cele Srbije, ukljucujuci Zlatiborski okrug. Posebno imamo iskustva sa turizmom i ugostiteljstvom, sto je kljucno za region Zlatibora, Tare i Mokre Gore.' },
  { q: 'Koliko kosta digitalni marketing za firmu u Uzicu?', a: 'Zavisi od obima i potreba. Izrada sajta krece od 300 evra, mesecni SEO od 300 evra, Google Ads od 500 evra sa upravljanjem. Za detalje pogledajte nase stranice o cenama ili nas kontaktirajte za besplatnu procenu.' },
  { q: 'Da li pokrivate okolna mesta poput Bajine Baste i Cajetine?', a: 'Naravno. Lokalni SEO i Google Ads kampanje mogu da ciljaju ceo Zlatiborski okrug, ukljucujuci Bajinu Bastu, Cajetinu, Kosjerić, Arilje i Pozegu. Za turističke objekte na Zlatiboru i Tari ovo je posebno vazno.' },
...
export default function MarketingAgencijaUzicePage() {
  usePageMeta()
  return (
    <div className="min-h-screen bg-page">
      <section className="relative pt-[140px] md:pt-[180px] pb-16 md:pb-24 px-4 md:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto text-center">
          <span className="inline-block text-[11px] uppercase tracking-[0.2em] text-ink-3 mb-5">Uzice · Srbija</span>
          <h1 className="text-[32px] md:text-[52px] font-medium leading-[1.1] tracking-[-1px] text-ink mb-5">Marketing agencija za Uzice</h1>
          <p className="text-[16px] md:text-[18px] text-ink-2 leading-relaxed max-w-[600px] mx-auto mb-8">
            Platinum Zenith pomaze firmama u Uzicu i Zlatiborskom okrugu da rastu online. Pravimo sajtove koji prodaju, vodimo kampanje koje donose merljive rezultate i optimizujemo konverzije za lokalne biznise i turizam.
          </p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[1100px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-10 text-center">Sta radimo za firme u Uzicu</h2>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto bg-panel rounded-[20px] border border-edge p-6 md:p-8">
          <h2 className="text-[22px] md:text-[26px] font-medium text-ink mb-5">Uzice u brojevima</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            {[
              { num: '78K+', label: 'Stanovnika grada' },
              { num: '300K+', label: 'Zlatiborski okrug' },
              { num: '12K+', label: 'Aktivnih firmi u okrugu' },
              { num: '1M+', label: 'Turista godisnje na Zlatiboru' },
            ].map(s => (
              <div key={s.label}>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Marketing kanali za biznise u Uzicu</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Uzice i Zlatiborski okrug su region sa jakom turističkom sezonom, rastućom privredom i niskom digitalnom konkurencijom. Firme koje ulazu u online marketing sada ce imati prednost u godinama koje dolaze.</p>
          <div className="space-y-6">
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              <h3 className="text-[17px] font-medium text-ink mb-2">Google Ads za Uzice i Zlatiborski okrug</h3>
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Cena po kliku za lokalne pretrage u Uzicu je znatno niza nego u Beogradu. Kampanje mogu da ciljaju i okolna mesta poput Bajine Baste, Cajetine i Kosjerca. Za turizam, ugostiteljstvo i lokalne usluge, Google Ads je najbrzi put do novih klijenata, posebno tokom sezone na Zlatiboru i Tari.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Google Business profil, lokalni sadrzaj i recenzije su kljucni za svaki biznis koji zavisi od lokalnih kupaca i turista. Vecina firmi u Uzicu nema optimizovan profil, sto otvara prostor za brze rezultate onima koji prvi krenu.</p>
            ...
            <div className="bg-panel rounded-[16px] border border-edge p-6">
              ...
              <p className="text-[14px] text-ink-2 leading-relaxed mb-3">Vizuelne kampanje za turizam, smestaj, restorane, salone i maloprodaju. Zlatibor, Tara i Mokra Gora su izuzetno fotogenicne destinacije koje generisu visok engagement na drustvenim mrezama, a sezonske kampanje mogu da popune kapacitete u predsezoni.</p>
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-24">
        <div className="max-w-[760px] mx-auto">
          <h2 className="text-[26px] md:text-[34px] font-medium text-ink mb-4 text-center">Industrije koje pokrivamo u Uzicu</h2>
          <p className="text-[15px] text-ink-2 leading-relaxed text-center mb-10 max-w-[600px] mx-auto">Specijalizovane strategije za industrije koje dominiraju u Zlatiborskom okrugu.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { title: 'Turizam i smestaj', link: '/marketing-za-restorane', desc: 'Booking kampanje, Google Ads i Instagram za apartmane i hotele' },
      ...
      <section className="px-4 md:px-8 pb-20 md:pb-32">
        <div className="max-w-[600px] mx-auto text-center">
          <h2 className="text-[22px] md:text-[28px] font-medium text-ink mb-4">Spremni za rast u Uzicu?</h2>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@graph": [{
          ...
          "name": "Platinum Zenith - Marketing Agencija Uzice",
          "url": "https://platinumzenith.com/marketing-agencija-uzice",
          "telephone": "+381668168929",
          "email": "aleksandar@platinumzenith.com",
          "areaServed": { "@type": "City", "name": "Uzice" },
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Marketing agencija Uzice", "item": "https://platinumzenith.com/marketing-agencija-uzice" }
          ]
        }]
      })}} />
    </div>

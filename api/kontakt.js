...
export default async function handler(req, res) {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
        <tr style="border-bottom: 1px solid #eee;">
          <td style="padding: 10px 0; font-weight: bold; color: #555; width: 120px;">Ime:</td>
        ...
        <tr>
          <td style="padding: 10px 0; font-weight: bold; color: #555; vertical-align: top;">Poruka:</td>
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #111;">Hvala na poruci, ${name.split(' ')[0]}!</h2>
          <p style="color: #333; line-height: 1.6;">Primili smo vašu poruku i javićemo vam se u roku od 24h.</p>
          <br>
